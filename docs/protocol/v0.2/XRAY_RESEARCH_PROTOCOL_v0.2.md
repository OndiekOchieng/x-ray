...
**Benchmark lineage:** XRAY-KE-001; XRAY-US-001  
...
## 2.11 Reported plurality does not establish independent origins

A publication may report that several anonymous officials, witnesses, analysts, or other sources support a proposition.

That source plurality is evidence about the publication's sourcing. It does not by itself establish that the underlying evidence origins are independent.

For example:

> "Four officials familiar with the incident said X."

must not silently become:

> "Four independent origins establish X."

The sources may be independently positioned, or they may share one briefing, report, source, record, or chain of transmission.

Record separately where possible:

- reported human-source count;
- identifiable evidence origins;
- confirmed independent origins;
- unresolved origin relationships.

When independence cannot be established, preserve it as unknown.

---

## 2.12 Institutional authority establishes statements at their actual strength

An official source is strong evidence for what an institution formally stated, ordered, recorded, published, or adopted.

It does not automatically establish the underlying real-world proposition.

For example:

> "The ministry reports the project is 80% complete."

directly establishes the ministry's reported figure.

It does not automatically establish that 80% physical completion independently occurred.

Trace the underlying measurement, record, inspection, dataset, or methodology when that proposition is load-bearing.

---

## 2.13 Influence does not establish intent

Evidence may establish that an actor materially influenced an information path through:
...
Those observations may justify investigating intent.

They must not, by themselves, be converted into findings that an actor intended to manipulate, coordinate, propagandize, manufacture consent, deceive, or produce a particular audience response.

Intent is allowed as a finding when evidence specifically bearing on purpose earns it.

Potentially relevant evidence includes direct instructions, communications, strategy documents, testimony, consistent independently supported conduct, or other evidence that bears on purpose rather than merely influence.

> **Do not prohibit findings about intent. Prohibit smuggling intent into the graph through evidence that only establishes influence.**

---

## 2.14 Keep influence, coordination, intent, and effect separate

These are distinct propositions:

### Influence
Who or what materially shaped the information path?

### Coordination
Did actors knowingly act together?

### Intent
What outcome, if any, were actors trying to produce?

### Effect
What measurable change, if any, occurred in audience belief, behaviour, policy, or institutional action?

Evidence establishing one does not automatically establish another.
...
Each material proposition must be independently supported and graded.

---

## 2.15 Counterfactual outcomes require their own evidence

Observed precursor events do not automatically establish what would have happened next.

For example:

> "Aircraft were airborne and a boarding operation was being prepared."

does not by itself establish:

> "The incident nearly started a war."

The latter is a counterfactual or escalation assessment.

It may be supportable through decision records, risk assessments, command communications, expert reconstruction, or other relevant evidence, but it must not inherit the certainty of the preceding observations.

---

## 2.16 Trace framing without turning framing into motive

For material stories, identify when reporting moves across:

`Observation → Interpretation → Meaning`

and preserve the transition.

The protocol may also reconstruct:

`origin → publication → repetition → amplification`

This information-flow trace helps a reader see how a proposition became the story they encountered.

A framing choice is not automatically deceptive.

An amplification pattern is not automatically coordinated.

A repeated phrase is not automatically evidence of intent.

Those are separate research questions.

---

## 2.17 Citizen-facing projection cannot increase certainty

A receipt, summary, card, visualization, notification, or other public projection must not imply:

- stronger evidence;
- greater source independence;
- higher confidence;
- greater completeness;
- a stronger causal claim;
- a stronger intent claim;

than the underlying investigation supports.

Compression may simplify presentation.

It may not strengthen epistemic meaning.

---

# 3. Pipeline

The X-Ray research method has ten research stages followed by two control gates:
...
Citizen-facing synthesis and civic action are lifecycle steps after the research state is allowed to graduate:

```text
RESEARCH STOP → SYNTHESIZE → ACT / RESOLVE
```

Validation asks whether the represented investigation violates deterministic protocol rules.

Review asks whether a validator-clean investigation remains epistemically suspicious, overclaims the evidence, collapses semantic distinctions, or requires revision.

For manual research runs, stages 1–10 and the applicable validation/review self-audit must be completed before citizen-facing synthesis is allowed.
...
Determine where each proposition-bearing piece of evidence actually originated and whether apparently separate support is genuinely independent.

TRACE answers:

> What evidence did we locate?

PROVENANCE answers:

> Where did that evidence come from, and how many independent origins does it really represent?

For each material evidence item, record where determinable:
...
For anonymous or opaque sourcing, distinguish:

- the number of sources a publication says it consulted;
- the number of identifiable originating records or witnesses;
- the number of origins whose independence can actually be established.

Do not manufacture source independence merely because several people are mentioned.

Do not collapse document lineage and proposition provenance.

A publication can depend on another publication while still containing some independently originated evidence; conversely, several publications can appear independent while relaying one underlying briefing or record.

Where relevant, construct an information-flow trace:

```text
origin → publication → syndication/repetition → commentary → amplification
```

This trace describes transmission.

It does not, by itself, establish coordination, motive, intent, or audience effect.
...
Check deterministic protocol conditions before interpretive review or synthesis.

At minimum, validate:

- references resolve;
- surface-source evidence is not treated as independent corroboration of itself;
- dependent repetitions are not counted as independent origins;
- incompatible measures are not labelled contradictions without reconciliation;
- missing evidence is not encoded as negative evidence;
- gaps required by unresolved findings remain reachable;
- claim/finding relationships remain internally consistent;
- synthesis has not mutated evidence state.

A validation failure is evidence that the represented investigation is not yet legal under the protocol.

Do not repair a failure by changing the meaning of the evidence.
...
Adversarially inspect a validator-clean investigation for epistemic failures that require judgment rather than deterministic structural checks.

Review should look especially for:

- non-atomic claims;
- Observation / Interpretation / Meaning collapse;
- proxy measures treated as the claimed measure;
- suspicious source-independence assumptions;
- anonymous-source plurality presented as confirmed independent origins;
- official assertions silently promoted into underlying reality;
- framing presented as evidence;
- influence presented as coordination or intent;
- intent presented as audience effect;
- counterfactual outcomes inheriting certainty from precursor events;
- rationale that silently changes definitions, time scope, modality, or tense;
- findings whose reversibility statement is too weak to be meaningful.

If review finds a material problem, revise the appropriate research stage rather than papering over the problem in prose.

A clean review does not mean the story is true.

It means the current investigation has survived the protocol's available adversarial checks.

---

# 16. Stage 13 — Synthesize

This stage is forbidden until research stages 1–10 are complete.
...
### HOW THIS INFORMATION TRAVELLED — when material

A concise provenance/amplification trace that distinguishes independent origins from repetition.

### FRAMING — when material

Show the relevant Observation → Interpretation → Meaning transitions without assigning unsupported motive.
...
- imply source independence that the provenance record does not establish;
- imply intent from influence alone;
- imply audience effect from intent alone;
- strengthen a counterfactual beyond its own evidence;
- let a simplified projection increase certainty.
...
# 18. Required benchmark artifacts

For model evaluation, research stages 1–10 must produce the core artifacts below.
...
Evidence-origin relationships, source dependencies, independence state, anonymous-source plurality where relevant, and material amplification paths.

## 08 — REVIEW NOTES

Any validator-clean but epistemically suspicious states, including framing, counterfactual, influence, coordination, intent, and effect boundary concerns.

---

# 19. Model benchmark rules
...
Anonymous-source plurality incorrectly counted as independent origins
Official assertion incorrectly promoted into underlying fact
Influence incorrectly promoted into intent
Intent incorrectly promoted into audience effect
Counterfactual claim incorrectly inheriting precursor certainty
...
# 20. Handling disagreement between researchers
...
## XRAY-US-001 — protocol-evolution run

**Date:** 2026-09-19

**Surface source:** CNN reporting on a U.S. military AI-assisted intelligence error concerning a Chinese vessel.

This manual run exposed additional methodological boundaries:

- a publication's multiple anonymous sources do not automatically establish multiple independent evidence origins;
- an official source strongly establishes what the institution says, not automatically the underlying proposition;
- observed influence does not by itself establish coordination, intent, or audience effect;
- intent may be established when evidence specifically bearing on purpose supports it;
- counterfactual escalation claims require evidence separate from the observed precursor events;
- information-flow and framing traces are useful analytical projections but must not be converted into unsupported motive claims.

These findings motivated Protocol v0.2.

---

# 22. Researcher execution instruction
...
>
> Follow X-Ray Research Protocol v0.2 exactly.
>
...
>
> Execute research stages 1 through 10, then run the VALIDATE and REVIEW control gates.
>
...
>
> Do not produce citizen-facing synthesis yet. Stop after REVIEW and report the research state.
>
> Return the required structured research artifacts, provenance/information-flow trace where material, and review notes and enough source information that another researcher can audit every material finding.
>
...
- [ ] Reported source plurality has not been mistaken for confirmed independent origins.
- [ ] Known source/evidence dependencies are represented.
- [ ] Unknown independence remains unknown.
- [ ] Material amplification paths are distinguished from independent corroboration.

### Framing, influence, and counterfactuals

- [ ] Observation, interpretation, and meaning transitions are visible where material.
- [ ] Official assertions are represented at their actual evidentiary strength.
- [ ] Influence has not been silently promoted into coordination or intent.
- [ ] Intent has not been silently promoted into audience effect.
- [ ] Counterfactual outcomes are graded on their own evidence.
...
- [ ] Deterministic validation checks pass or failures remain explicitly visible.
- [ ] Validator-clean but epistemically suspicious states received review.
- [ ] Material review findings were routed back to the appropriate research stage rather than hidden in synthesis.
...
- anonymous-source plurality is being mistaken for independent origins;
- official statements are being treated as self-proving underlying reality;
- influence is being converted into unsupported intent;
- counterfactual consequences are inheriting certainty from precursor events;
- citizen-facing compression is increasing apparent certainty.
...
**X-Ray Research Protocol v0.2.0**

Protocol v0.2 incorporates lessons from XRAY-KE-001 and the manual XRAY-US-001 protocol-evolution run.

It is the current protocol for new manual investigations.

Protocol v0.1 remains frozen historical evidence for XRAY-KE-001 comparability.

New runs should use the matching v0.2 action prompt.