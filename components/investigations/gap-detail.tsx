          ...
          <div className="flex min-w-0 flex-col gap-6">
            ...
            <section className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-3 leading-7 text-muted-foreground">
                {gap.atiEligible
                  ...
                  : 'This gap cannot become an information request. The record does not exist yet — no request can produce it, however material the question is.'}
              </p>
            </section>
            ...
            {draft ? (
              ...
              <section className="rounded-2xl border border-border bg-card p-6">
                ...
                <h2 className="mt-2 text-2xl font-semibold">{gap.resolutionPathLabel}</h2>
                <p className="mt-3 leading-7 text-muted-foreground">
                  No information request is drafted for this gap. X-Ray is waiting for a record
                  that does not exist yet; the evidence that would settle it is listed above.
                </p>
              </section>
            )}
